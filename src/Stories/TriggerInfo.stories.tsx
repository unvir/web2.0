...
stories.forEach(({
  ...
  story.add(title, () => <TriggerInfo supportEmail="support@mail.ru" triggerState={state} data={data} onThrottlingRemove={action("onThrottlingRemove")} onSetMaintenance={action("onSetMaintenance")} />);
});