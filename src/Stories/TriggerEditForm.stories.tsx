...
const stories = [{
  ...
  data: {
    ...
    expression: "t1 > 134500 ? ERROR : (PREV_STATE == OK ? (t1 > 5 : WARN ? OK) : (t1 > 6000000000 ? WARN : OK))",
    sched: {
      startOffset: 0,
      endOffset: 1439,
      tzOffset: -300,
  ...
  data: {
    ...
    targets: ["aliasByNode(DevOps.system.*ditrace*.process.*.uptime, 2, 4)", "aliasByNode(DevOps.system.*ditrace*.process.*.uptime, 6, 8)"],
...
stories.forEach(({
  ...
  story.add(title, () => <ValidationContainer>
