    ...
    return <Layout loading={loading} error={error}>
                <LayoutContent>
                            ...
                            <ColumnStack block gap={6} horizontalAlign="stretch">
                                <Fit>
                                    <ValidationContainer ref={this.validationContainer}>
                                        {config != null && <TriggerEditForm data={trigger} tags={tags || []} remoteAllowed={config.remoteAllowed} onChange={update => this.handleChange(update)} />}
                                    </ValidationContainer>
                                </Fit>
                                <Fit>
                    ...
                    this.handleSubmit();
                                        ...
                                        <Fit>
                                            <RouterLink to={getPageLink("trigger", match && match.params && match.params.id ? match.params.id : "")}>
                                                Cancel
                                            </RouterLink>
                                        </Fit>
                                    </RowStack>
