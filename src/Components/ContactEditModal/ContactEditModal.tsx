  ...
  render(): React.ReactNode {
    ...
    return <Modal onClose={onCancel} ignoreBackgroundClick>
                ...
                <Modal.Footer panel sticky>
                    <Gapped gap={10}>
                        <Button use="primary" disabled={isActionButtonDisabled} loading={updateInProcess} onClick={() => {
            this.handleUpdateContact();
          }}>
                            Save
                        </Button>
                        <Button loading={updateAndTestInProcess} disabled={isActionButtonDisabled} onClick={() => {
            this.handleUpdateAndTestContact();
          }}>
                            Save and test
                        </Button>
                        <Button use="danger" loading={deleteInProcess} disabled={isActionButtonDisabled} onClick={() => {
