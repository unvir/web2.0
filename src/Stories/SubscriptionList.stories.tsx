...
storiesOf("SubscriptionList", module).addDecorator(story => <ValidationContainer>{story()}</ValidationContainer>).add("Defualt", () => <SubscriptionList {...commonProps} tags={tags} contacts={contacts} subscriptions={[{
  ...
  ignore_recoverings: false,
  ignore_warnings: false
}]} />).add("WithDisabledItem", () => <SubscriptionList {...commonProps} tags={tags} contacts={contacts} subscriptions={[{
  sched: createSchedule(WholeWeek),
  tags: ["1"],
  throttling: false,
  contacts: ["1"],
  ...
  ignore_recoverings: false,
  ignore_warnings: false
}]} />).add("FewChannelsForSubscription", () => <SubscriptionList {...commonProps} tags={tags} contacts={contacts} subscriptions={[{
  sched: createSchedule(WholeWeek),
  tags: ["1"],
  throttling: false,
  contacts: ["1"],
  ...
  ignore_recoverings: false,
  ignore_warnings: false
}]} />).add("WithManyTags", () => <SubscriptionList {...commonProps} tags={tags} contacts={contacts} subscriptions={[{
  sched: createSchedule(WholeWeek),
  tags: ["1"],
  throttling: false,
  contacts: ["1"],
