...
export default class FormattedNumberInput extends React.Component<FormattedNumberInputProps> {
  ...
  handleValueForView(value: number | null | undefined): string {
    return value != null ? numeral(value).format(this.props.viewFormat || this.props.editFormat || "0.0[00000]") : "";
  }
  ...
  render(): React.ReactNode {
    ...
    return <FilteredInput ref="filteredInput" {...restProps} value={value} filterValue={value => this.handleFilterValue(value)} valueForView={value => this.handleValueForView(value)} valueForEdit={value => this.handleValueForEdit(value)} />;
  }
}