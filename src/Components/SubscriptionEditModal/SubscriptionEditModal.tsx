  ...
  render(): React.ReactNode {
    ...
    return <Modal ignoreBackgroundClick onClose={onCancel}>
                ...
                <Modal.Footer panel sticky>
                    <Gapped gap={10}>
                        <Button use="primary" disabled={isActionButtonsDisabled} loading={updateInProcess} onClick={() => {
            this.handleUpdate();
          }}>
                            Save
                        </Button>
                        <Button disabled={isActionButtonsDisabled} loading={updateAndTestInProcess} onClick={() => {
            this.handleUpdateAndTest();
          }}>
                            Save and test
                        </Button>
                        <Button use="danger" disabled={isActionButtonsDisabled} loading={deleteInProcess} onClick={() => {
            this.handleDelete();
          }}>
                            Delete
                        </Button>
