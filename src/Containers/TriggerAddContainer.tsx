...
type State = {
  ...
  trigger: $Shape<Trigger> | null | undefined;
                            ...
                            <ColumnStack block gap={4}>
                                <Fit>
                                    <ValidationContainer ref={this.validationContainer}>
                                        {config != null && <TriggerEditForm data={trigger} remoteAllowed={config.remoteAllowed} tags={tags || []} onChange={update => this.handleChange(update)} />}
                                    </ValidationContainer>
                                </Fit>
                                <Fit>
