...
function Outline(props: {children: React.ReactNode;}): React.ReactNode {
  const {
    children
  } = props;
  return <div style={{
...
storiesOf("ItemsStack", module).add("RowStack", () => <RowStack block gap={2}>
            <Fit>
        ...
        </RowStack>).add("ColumnStack", () => <ColumnStack block stretch gap={2} style={{ height: "300px" }}>
            <Fit>
                <Outline>Fit Item</Outline>
            </Fit>
            <Fill>
