...
export default function Tag(props: Props): React.ReactNode {
  ...
  if (typeof onClick === "function") {
    return <div className={cn({ tag: true, focused: focus })} style={getColor(title)}>
  ...
  if (typeof onRemove === "function") {
    ...
    return <div className={cn({ tag: true, removeable: true, focused: focus })} style={getColor(title)}>
  ...
  return <div className={cn({ tag: true, removeable: onRemove, focused: focus })} style={getColor(title)}>
            <div className={cn("title")}>{title}</div>
        </div>;
}