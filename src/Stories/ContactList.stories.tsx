...
storiesOf("ContactList", module).add("empty", () => <ContactList {...commonProps} items={[]} />).add("one item", () => <ContactList {...commonProps} items={[{
  id: "1",
  type: "email",
  user: "1",
  value: "test@mail.ru"
}]} />).add("few items", () => <ContactList {...commonProps} items={[{
  id: "1",
  type: "phone",
  user: "1",
  value: "9876543210"
