...
export default class FilteredInput<T> extends React.Component<
    ...
    FilteredInputState
> {
    innerInputRef: React.RefObject<Input> | null | undefined;
    testWidthRef: React.RefObject<HTMLDivElement> | null | undefined;
    rootRef: React.RefObject<HTMLSpanElement> | null | undefined;
    ...
    handleInputChange(value: string): void {
        ...
        if (filteredValue !== null) {
            ...
            this.setState({}, () => {
                if (this.innerInputRef != null) {
                    this.innerInputRef.setSelectionRange(this.selectionStart, this.selectionEnd);
                }
            });
        }
    }
    ...
    getClip(value: string | null | undefined): number {
        if (this.testWidthRef != null && this.rootRef != null) {
            this.testWidthRef.innerHTML = value || "";
            const result = this.rootRef.offsetWidth - this.testWidthRef.offsetWidth;
            return result - 9;
        }
        return 0;
    }
