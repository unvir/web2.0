...
const story = storiesOf("Mobile/TriggerInfoPage", module).addDecorator(StoryRouter()).addParameters({
  creevey: {
    skip: {
      stories: "Loading",
...
story.add("Loading", () => <MobileTriggerInfoPage data={null} triggerState={null} metrics={null} loading onRemoveMetric={action("onRemoveMetric")} onSetMetricMaintenance={action("onSetMetricMaintenance")} onSetTriggerMaintenance={action("onSetTriggerMaintenance")} onThrottlingRemove={action("onThrottlingRemove")} />);
...
stories.forEach(({
  ...
  story.add(title, () => <MobileTriggerInfoPage triggerState={state} data={data} metrics={null} onRemoveMetric={action("onRemoveMetric")} onSetMetricMaintenance={action("onSetMetricMaintenance")} onSetTriggerMaintenance={action("onSetTriggerMaintenance")} onThrottlingRemove={action("onThrottlingRemove")} />);
});