...
export default class ContactSelect extends React.Component<Props> {
  ...
  render(): React.ReactNode {
    ...
    return <div onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
                ...
                <div>
                    <ComboBox error={error} warning={warning} width="100%" onFocus={onFocus} onBlur={onBlur} onValueChange={this.handleChangeContactToAdd} getItems={this.getContactsForComboBox} placeholder="Select delivery channel" renderNotFound={() => "No delivery channels found"} renderItem={item => <>
