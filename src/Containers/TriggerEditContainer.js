...
var TriggerEditContainer = /** @class */ (function (_super) {
    __extends(TriggerEditContainer, _super);
    function TriggerEditContainer(props) {
        var _this = _super.call(this, props) || this;
        _this.handleSubmit = function () { return __awaiter(_this, void 0, void 0, function () {
            var trigger, _a, moiraApi, history, isValid, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, moiraApi.setTrigger(trigger.id, trigger)];
                    case 3:
                        _b.sent();
                        history.push(Global_1.getPageLink("trigger", trigger.id));
                        return [3 /*break*/, 5];
                    case 4:
                        error_1 = _b.sent();
        ...
        _this.deleteTrigger = function (id) { return __awaiter(_this, void 0, void 0, function () {
            var _a, moiraApi, history, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, moiraApi = _a.moiraApi, history = _a.history;
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, moiraApi.delTrigger(id)];
                    case 2:
                        _b.sent();
                        history.push(Global_1.getPageLink("index"));
                        return [3 /*break*/, 4];
                    case 3:
                        error_2 = _b.sent();
    ...
    TriggerEditContainer.prototype.componentDidMount = function () {
        document.title = "Moira - Edit trigger";
        this.getData(this.props);
    };
    TriggerEditContainer.prototype.componentWillReceiveProps = function (nextProps) {
        this.setState({ loading: true });
        this.getData(nextProps);
    };
    TriggerEditContainer.prototype.render = function () {
        var _this = this;
        ...
        return React.createElement(Layout_1.default, { loading: loading, error: error },
            React.createElement(Layout_1.LayoutContent, null,
                React.createElement(Layout_1.LayoutTitle, null, "Edit trigger"),
                    ...
                    React.createElement(ItemsStack_1.ColumnStack, { block: true, gap: 6, horizontalAlign: "stretch" },
                        ...
                        React.createElement(ItemsStack_1.Fit, null,
                            React.createElement(ItemsStack_1.RowStack, { gap: 3, baseline: true },
                                React.createElement(ItemsStack_1.Fit, null,
                                    React.createElement(Button_1.Button, { use: "primary", onClick: this.handleSubmit }, "Save trigger")),
                                React.createElement(ItemsStack_1.Fit, null,
                                    React.createElement(Button_1.Button, { use: "link", icon: React.createElement(Trash_1.default, null), onClick: function () { return _this.deleteTrigger(trigger.id); } }, "Delete")),
                                React.createElement(ItemsStack_1.Fit, null,
                                    React.createElement(RouterLink_1.default, { to: Global_1.getPageLink("trigger", trigger.id) }, "Cancel"))))))));
    };
    TriggerEditContainer.prototype.handleChange = function (update) {
        this.setState(function (prevState) { return ({ trigger: __assign(__assign({}, prevState.trigger), update) }); });
    };
    TriggerEditContainer.prototype.getData = function (props) {
        return __awaiter(this, void 0, void 0, function () {
            var moiraApi, match, id, trigger, list, config, error_3;
    ...
    TriggerEditContainer.prototype.validateForm = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    return TriggerEditContainer;
}(React.Component));
exports.default = MoiraApiInjection_1.withMoiraApi(TriggerEditContainer);
