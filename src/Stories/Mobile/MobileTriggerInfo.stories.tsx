...
const stories = [{
  ...
  triggerState: {
    ...triggerState,
    state: "EXCEPTION",
    msg: "Some error very very very very very very very very very very very message message message message message."
  },
  data: sourceData
}, {
...
stories.forEach(({
  ...
  story.add(title, () => <MobileTriggerInfo triggerState={state} data={data} onThrottlingRemove={action("onThrottlingRemove")} onSetMaintenance={action("onSetMaintenance")} />);
});