...
function SelectorInitialView(_a) {
    ...
    return React.createElement(React.Fragment, null,
        React.createElement("p", { className: SearchSelector_less_1.default("help-search") },
            "Input query then press ",
            React.createElement("span", { className: SearchSelector_less_1.default("keyboard-key") }, "Enter"),
            " for full text search or select tag from list with mouse click"),
        tokens.length > 0 && React.createElement(React.Fragment, null,
            React.createElement("p", { className: SearchSelector_less_1.default("token-list-label") }, "Tags from your subscriptions"),
...
exports.default = SelectorInitialView;
