...
type State = {
  ...
  list: Array<Pattern> | null | undefined;
  ...
  render(): React.ReactNode {
    ...
    return <Layout loading={loading} error={error}>
                <LayoutContent>
                    ...
                    {list && <PatternList items={this.sortPatterns(list)} onSort={sorting => {
        ...
        }} sortingColumn={sortingColumn} sortingDown={sortingDown} onRemove={pattern => {
