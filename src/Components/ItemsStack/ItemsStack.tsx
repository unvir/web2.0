...
export class RowStack extends React.Component<RowStackProps> {
  ...
  render(): React.ReactNode {
    ...
    return <TagComponent id={id} className={cn("row-stack", `gap-${gap.toString()}`, { block }, className)} style={{
      ...style,
...
export class ColumnStack extends React.Component<ColumnStackProps> {
  ...
  render(): React.ReactNode {
    ...
    const TagComponent = tag || "div";
    return <TagComponent className={cn("column-stack", `gap-${gap.toString()}`, { block }, className)} style={{
      ...style,
...
export function Fit({
  ...
  children,
  ...rest
}: FitProps): React.ReactElement<any> {
  const TagComponent = tag || "div";
  return <TagComponent className={cn(className, "fit")} {...rest}>
            {children}
        </TagComponent>;
}
...
export function Fill({
  ...
  const TagComponent = tag || "div";
  return <TagComponent className={cn("fill", className)} {...rest}>
            {children}
        </TagComponent>;
}
...
export function Fixed({
  ...
  allowWrap,
  ...rest
}: FixedProps): React.ReactNode {
  const TagComponent = tag || "div";
  return <TagComponent className={cn("fixed", { "no-overflow": !allowWrap }, className)} style={{ ...style, width }} {...rest}>
            {children}
        </TagComponent>;
}