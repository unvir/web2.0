...
function SpaceFiller(props: Props): React.ReactNode {
  const {
    width = "100%",
    height = 300,
    label = "Children"
...
storiesOf("Layout", module).add("Default", () => <Layout>
        ...
        </Layout>).add("With Error", () => <Layout error="Error message here">
            <Layout.Content>
                <SpaceFiller />
            </Layout.Content>
        </Layout>).add("With Plate", () => <Layout>
            <Layout.Plate>
        ...
        </Layout>).add("With Plate and paging", () => <Layout>
            <Layout.Plate>
                <SpaceFiller height={50} label="Plate" />
            </Layout.Plate>
            <Layout.Content>
