...
export default class TriggerEditForm extends React.Component<Props, State> {
  ...
  render(): React.ReactNode {
    ...
    return <Form>
                ...
                <FormRow label="Description" useTopAlignForLabel>
                    ...
                    {descriptionMode === "edit" ? <Textarea width="100%" value={desc || ""} onValueChange={value => onChange({ desc: value })} /> : <div className={cn("wysiwyg", "description-preview")} dangerouslySetInnerHTML={{
        ...
        <div key={`target-${i}`} className={cn("target")}>
                            ...
                            <div className={cn("fgroup")}>
                                ...
                                {targets.length > 1 && <div className={cn("fgroup-control")}>
  ...
  renderNewMetricsAlertingHelp = () => <div className={cn("new-metrics-help")}>
