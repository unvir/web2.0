...
storiesOf("Mobile/MetricsList", module).addDecorator(StoryRouter()).add("With Status Indicator", () => <MobileMetricsList metrics={items} onRemove={action("onRemove")} onSetMaintenance={action("onSetMaintenance")} />);