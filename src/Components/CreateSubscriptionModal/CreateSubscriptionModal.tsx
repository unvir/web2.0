...
type Props = {
  ...
  onCancel: () => void;
  onCreateSubscription: (arg0: SubscriptionInfo) => Promise<void>;
  onCreateAndTestSubscription: (arg0: SubscriptionInfo) => Promise<void>;
};
    ...
    return <Modal ignoreBackgroundClick onClose={onCancel}>
                ...
                <Modal.Body>
                    <ValidationContainer ref={this.validationContainer}>
                        <SubscriptionEditor subscription={subscription} onChange={this.handleChange} tags={tags} contacts={contacts} />
                    </ValidationContainer>
                </Modal.Body>
                <Modal.Footer panel sticky>
                    <ModalError message={error} maxWidth="450px" />
                    <RowStack gap={2} block baseline>
                        <Button use="primary" disabled={isActionButtonsDisabled} loading={createInProcess} onClick={this.handleCreate}>
                            Add
                        </Button>
                        <Button disabled={isActionButtonsDisabled} loading={createAndTestInProcess} onClick={this.handleCreateAndTest}>
                            Add and test
                        </Button>
                        <Fill />
