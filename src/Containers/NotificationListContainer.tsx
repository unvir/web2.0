...
class NotificationListContainer extends React.Component<Props, State> {
  ...
  static composeNotifications(items: Array<Notification>): {
  ...
  render(): React.ReactNode {
    ...
    return <Layout loading={loading} error={error}>
                <LayoutContent>
                    ...
                    {list && <NotificationList items={NotificationListContainer.composeNotifications(list)} onRemove={id => {
          ...
          alignContent: "center"
            ...
            this.removeAllNotifications();
                        ...
                        <ToggleWithLabel label={notifierEnabled ? "Notifications enabled" : "Notifications disabled"} checked={notifierEnabled} onChange={checked => this.enableNotifier(checked)} />
                    </div>
                </LayoutFooter>
            </Layout>;
  }
