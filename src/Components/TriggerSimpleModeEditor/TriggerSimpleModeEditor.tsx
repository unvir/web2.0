...
export type TriggerSimpleModeSettings = {
  warn_value: number | null | undefined;
    ...
    return <div>
                <ColumnStack block gap={4} stretch>
                        ...
                        <ColumnStack block gap={2} stretch>
                            <Fit>
                                <span className={cn("radio")}>
                                    <Radio checked={watchFor === "rising"} value="rising" onValueChange={this.handleSetWatchType}>
                            ...
                            <Fit className={cn("state-block")}>
                                <RowStack block baseline gap={2}>
                                    ...
                                    <Fixed className={cn("state-caption", {
                  disabled: watchFor !== "rising"
                })} width={100}>
                                        WARN if T1 ≥{" "}
                                    </Fixed>
                                    <Fit>
                                        <ValidationWrapperV1 renderMessage={tooltip("right middle")} validationInfo={this.validateRisingWarn()}>
                                            <FormattedNumberInput width={120} editFormat={defaultNumberEditFormat} viewFormat={defaultNumberViewFormat} value={risingValues.warn_value} onChange={this.handleChangeWarnValue} disabled={watchFor !== "rising"} />
                                        </ValidationWrapperV1>
                                    </Fit>
                                </RowStack>
                            </Fit>
                  ...
                  disabled: watchFor !== "rising"
                                    ...
                                    <Fit>
                                        <ValidationWrapperV1 renderMessage={tooltip("right middle")} validationInfo={this.validateRisingError()}>
                                            <FormattedNumberInput width={120} editFormat={defaultNumberEditFormat} viewFormat={defaultNumberViewFormat} value={risingValues.error_value} onChange={this.handleChangeErrorValue} disabled={watchFor !== "rising"} />
                                        </ValidationWrapperV1>
                                    </Fit>
                                </RowStack>
                            </Fit>
                    ...
                    <Fit>
                        <ColumnStack block gap={2} stretch>
                            <Fit>
                                <span className={cn("radio")}>
                                    <Radio checked={watchFor === "falling"} value="falling" onValueChange={this.handleSetWatchType}>
                  ...
                  disabled: watchFor !== "falling"
                                    ...
                                    <Fit>
                                        <ValidationWrapperV1 renderMessage={tooltip("right middle")} validationInfo={this.validateFallingWarn()}>
                                            <FormattedNumberInput width={120} editFormat={defaultNumberEditFormat} viewFormat={defaultNumberViewFormat} value={fallingValues.warn_value} onChange={this.handleChangeWarnValue} disabled={watchFor !== "falling"} />
                                        </ValidationWrapperV1>
                                    </Fit>
                                </RowStack>
                            </Fit>
                  ...
                  disabled: watchFor !== "falling"
                                    ...
                                    <Fit>
                                        <ValidationWrapperV1 renderMessage={tooltip("right middle")} validationInfo={this.validateFallingError()}>
                                            <FormattedNumberInput width={120} editFormat={defaultNumberEditFormat} viewFormat={defaultNumberViewFormat} value={fallingValues.error_value} onChange={this.handleChangeErrorValue} disabled={watchFor !== "falling"} />
                                        </ValidationWrapperV1>
                                    </Fit>
                                </RowStack>
                            </Fit>
